...
export default function TopBar() {
  ...
  return (
    <header className="fixed top-0 md:left-72 left-0 right-0 h-16 z-40 bg-[#fcfaf7]/80 backdrop-blur-md border-b border-stone-200 flex items-center px-4 md:px-8 gap-4">
      {/* Breadcrumb */}

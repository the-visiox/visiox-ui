...
import { HeartPulse, Microscope, Activity, Crosshair, ShieldCheck, Zap, Clock } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  subtitle: [
    "Advancing patient care and clinical efficiency with medical-grade computer",
    "vision and intelligent diagnostic support.",
  ].join(" "),
  ...
  useCases: [
    {
      ...
      tag: "Operating Room",
      description: "Counting and tracking surgical instruments during operations to prevent retained foreign objects.",
      image: "/solutions/usecases/pathology.jpg",
      metric: "0 Retained Items",
    },
    {
      title: "Pill Defect Sorting",
      tag: "Pharmaceutical",
      description: "High-speed line screening to instantly reject broken, miscolored, or incorrectly dosed capsules.",
      image: "/solutions/usecases/medical-pills.jpg",
      metric: "99.99% Reliable",
    },
    {
      title: "Radiological Anomaly Detection",
      tag: "Roboflow Health",
      description:
        "Deep learning segmentation of X-Rays to highlight potential fractures and anomalies for secondary review.",
  ...
  ctaSubtitle: [
    "Discuss your medical vision requirements with our engineering team for",
    "HIPAA-compliant, high-performance integration.",
  ].join(" "),

...
import { CheckCircle2, Settings2, ShieldAlert, Cpu, Target, TrendingUp, ArrowRight, Clock } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  useCases: [
    {
      title: "3D Random Bin Picking",
      tag: "SolVision",
      description: "Enabling robot arms to pick unsorted, overlapping metal parts from deep bins with zero collision.",
    ...
    },
    {
      ...
      tag: "Roboflow Core",
      description:
        "Spotting micro-fissures, rust, and scratches on aluminum casings using ultra-high resolution inspection.",
      image: "/solutions/usecases/pcb-inspection.jpg",
      metric: "1B+ Images Trained",
    },
    {
      title: "6D Pose Estimation",
      tag: "Automotive",
      description:
        "Detecting the exact orientation of complex engine components for precise automated grasping and assembly.",
      image: "/solutions/usecases/car-paint.jpg",
      metric: "Sub-mm Precision",
    },
  ],

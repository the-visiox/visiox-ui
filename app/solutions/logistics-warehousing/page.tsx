...
import { Package, Truck, Barcode, Layers, Zap, CheckCircle, ArrowRight, Maximize2 } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  capabilitiesSubtitle: [
    "Seamlessly integrate our vision stack with WMS, ERP, and industrial PLC",
    "systems for end-to-end operational visibility.",
  ].join(" "),
  capabilities: [
    {
    ...
    },
    {
      ...
      icon: <Maximize2 className="w-6 h-6 text-orange-500" />,
    },
    {
  ...
  useCases: [
    {
      title: "Conveyor Belt OCR",
      tag: "Roboflow Core",
      description: [
        "High-speed OCR reading damaged, wrinkled, or partially obscured barcodes and",
        "shipping labels on fast-moving conveyor belts.",
      ].join(" "),
    ...
    },
    {
      ...
      tag: "SolVision 3D",
      description: [
        "Using 3D vision systems to instantly calculate the volume, boundaries, and",
        "dimensions of incoming mixed-freight pallets.",
      ].join(" "),
      image: "/solutions/usecases/cold-storage.jpg",
      metric: "Instant Calc",
    },
    {
      title: "Damaged Parcel Detection",
      tag: "Intake Automation",
      description: [
        "Automatically flagging crushed, wet, or damaged packages at the intake dock",
        "before they enter the sorting system.",
      ].join(" "),

...
import { Leaf, Sprout, CloudSun, Droplets, TrendingUp, Target } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  capabilitiesSubtitle: [
    "Our computer vision platform is ruggedized for outdoor environments, operating",
    "across varying light conditions and weather patterns.",
  ].join(" "),
  capabilities: [
    {
  ...
  useCases: [
    {
      title: "Weed Detection Spraying",
      tag: "Roboflow Core",
      description: [
        "Tractor-mounted cameras identifying weeds vs. crops in real-time to",
        "selectively apply herbicide, saving costs.",
      ].join(" "),
      image: "/solutions/usecases/agri-drone.jpg",
      metric: "70% Chemical Saved",
    },
    {
      title: "Aerial Crop Health",
      tag: "Drone Mapping",
      description:
        "Using drone imagery to spot blight, pest damage, and irrigation leaks across hundreds of acres instantly.",
      image: "/solutions/usecases/apple-sorting.jpg",
      metric: "2x Yield Protection",
    },
    {
      title: "Automated Apple Sorting",
      tag: "SolVision",
      description:
        "High-speed conveyor systems evaluating the color, size, and bruising of apples for grocery grading.",
  ...
  ctaSubtitle:
    "Our agriculture AI experts are ready to help you deploy visual intelligence across your fields or facility.",

...
import { Car, TrafficCone, Signal, Navigation, Zap, Wind, Map } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  subtitle:
    "Harnessing computer vision to create safer, cleaner, and more efficient urban environments for every citizen.",
  ...
  capabilitiesSubtitle: [
    "By processing visual data at the edge, VisioX provides cities with the",
    "analytics needed to optimize mobility and safety.",
  ].join(" "),
  capabilities: [
    {
  ...
  useCases: [
    {
      title: "Automated ALPR Systems",
      tag: "Roboflow Hub",
      description: [
        "Deep learning models instantly identifying license plates across various",
        "countries in difficult lighting and weather conditions.",
      ].join(" "),
      image: "/solutions/usecases/toll-booth.jpg",
      metric: "99.95% OCR Acc.",
    },
    {
      title: "Intersection Flow Control",
      tag: "Municipal AI",
      description: [
        "Analyzing real-time traffic density and pedestrian movement to dynamically",
        "adjust light timings and reduce gridlock.",
      ].join(" "),
      image: "/solutions/usecases/traffic-signal.jpg",
      metric: "-15% Wait Time",
    },
    {
      title: "Dashcam Asset Mapping",
      tag: "Smart City",
      description: [
        "City fleet vehicles using AI dashcams to continually map and report potholes,",
        "graffiti, and broken streetlights automatically.",
      ].join(" "),

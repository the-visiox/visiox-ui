...
const solutions = [
  {
    ...
    description:
      "Streamline production lines with AI-powered inspection, assembly verification, and predictive maintenance.",
  ...
  },
  {
    ...
    description:
      "Optimize traffic flow, autonomous vehicle navigation, and intelligent public infrastructure monitoring.",
  ...
  },
  {
    ...
    description:
      "AI-assisted diagnostics, surgical robot guidance, and patient monitoring for improved health outcomes.",
...
export default function SolutionsPage() {
  return (
    <div className="min-h-screen bg-[#fcfaf7]">
      {/* Hero Section */}
      <section
        className={["pt-32 pb-20 px-6 lg:px-8 bg-white border-b border-stone-100 relative", "overflow-hidden"].join(
          " ",
        )}
      >
        <div className="absolute inset-0 pointer-events-none">
          <div
            className={[
              "absolute top-0 right-0 w-[500px] h-[500px] bg-orange-50 rounded-full blur-3xl",
              "-translate-y-1/2 translate-x-1/2",
            ].join(" ")}
          />
          <div
            className={[
              "absolute bottom-0 left-0 w-[500px] h-[500px] bg-stone-50 rounded-full blur-3xl",
              "translate-y-1/2 -translate-x-1/2",
            ].join(" ")}
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Badge className="mb-6">Industry Applications</Badge>
            ...
            <p className="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed">
              Explore how VisioX&apos;s cutting-edge computer vision platform transforms industries, automates complex
              tasks, and unlocks unprecedented visual insights.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {solutions.map((solution, index) => (
              ...
              >
                <Link
                  href={solution.href}
                  className={[
                    "group block h-full bg-white rounded-3xl border border-stone-200 overflow-hidden",
                    "hover:shadow-2xl hover:border-orange-200 transition-all duration-500",
                  ].join(" ")}
                >
                  <div className="relative aspect-[16/10] overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <Badge accentHex={solution.accentHex}>{solution.title.split(" & ")[0]}</Badge>
                    </div>
                  </div>
                  ...
                  <div className="p-8">
                    <h3
                      className={[
                        "text-2xl font-bold text-stone-900 mb-3 group-hover:text-orange-600",
                        "transition-colors",
                      ].join(" ")}
                    >
                      {solution.title}
                    </h3>
                    <p className="text-stone-600 leading-relaxed mb-6">{solution.description}</p>
                    <div
                      className={[
                        "flex items-center text-orange-600 font-bold group-hover:gap-2",
                        "transition-all",
                      ].join(" ")}
                    >
      ...
      <section className="py-20 px-6 lg:px-8 bg-stone-900">
        <div
          className={[
            "max-max-w-7xl mx-auto rounded-3xl bg-gradient-to-r from-orange-600 to-orange-400 p-12",
            "lg:p-20 text-center text-white relative overflow-hidden",
          ].join(" ")}
        >
          <div
            className={[
              "absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -translate-y-1/2",
              "translate-x-1/2",
            ].join(" ")}
          />
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className={[
                  "px-8 py-4 bg-white text-orange-600 rounded-xl font-bold hover:bg-stone-50",
              ...
              <Link
                href="/demo"
                className={[
                  "px-8 py-4 bg-orange-700 text-white rounded-xl font-bold hover:bg-orange-800",
                  "transition-colors border border-orange-500",
                ].join(" ")}
              >
                Book a Demo
              </Link>

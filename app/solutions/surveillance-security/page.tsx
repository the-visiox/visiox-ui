...
import { ShieldCheck, Eye, BellRing, MapPin, Zap, Lock, Search } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  subtitle: [
    "Next-generation security solutions powered by deep learning for proactive",
    "threat detection and real-time situational awareness.",
  ].join(" "),
  ...
  capabilitiesSubtitle: [
    "We combine edge computing with deep neural networks to provide instantaneous",
  ...
  capabilities: [
    ...
    },
    {
      ...
      icon: <BellRing className="w-6 h-6 text-orange-500" />,
    },
    {
  ...
  useCases: [
    {
      ...
      tag: "Roboflow Core",
      description: "Identifying firearms in live CCTV feeds instantly to trigger proactive facility lockdowns.",
      image: "/solutions/usecases/airport-security.jpg",
      metric: "0.2s Alert Time",
    },
    {
      title: "Perimeter Intrusion",
      tag: "Thermal Vision",
      description:
        "Distinguishing humans from animals or debris along restricted borders using customized thermal models.",
    ...
    },
    {
      ...
      tag: "Public Transit",
      description:
        "Tracking stationary items over time in crowded transit hubs to alert security of potential threats.",
      image: "/solutions/usecases/retail-security.jpg",
      metric: "99% Reliability",
    },
  ],

  ctaTitle: "Secure your perimeter today.",
  ctaSubtitle: [
    "Experience the power of proactive surveillance. Request a vulnerability",
    "assessment and see how VisioX can harden your security posture.",
  ].join(" "),

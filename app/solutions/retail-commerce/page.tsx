...
import { ShoppingBag, Users, BarChart3, Tag, Sparkles, Timer, TrendingUp } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  subtitle: [
    "Transform your store into a data-driven powerhouse with computer vision that",
    "understands every customer interaction and shelf movement.",
  ].join(" "),
  ...
  capabilitiesSubtitle:
    "We bring the deep analytics of e-commerce to the physical storefront, providing unprecedented visibility.",
  capabilities: [
    {
  ...
  useCases: [
    {
      ...
      tag: "Roboflow Retail",
      description:
        "Scanning grocery aisles with mounted cameras to identify out-of-stock items and alert restocking teams.",
      image: "/solutions/usecases/retail-shop.jpg",
      metric: "98% Shelf Uptime",
    },
    {
      title: "Frictionless Self-Checkout",
      tag: "Point of Sale",
      description:
        "Bypassing barcodes by having AI instantly recognize fresh produce or unlabelled items on the scale.",
      image: "/solutions/usecases/grocery-shelf.jpg",
      metric: "3x Faster Checkout",
    },
    {
      title: "Automated Spill Detection",
      tag: "Safety Systems",
      description:
        "Proactively pinging janitorial staff when a liquid spill or hazard is identified in shopping aisles.",
      image: "/solutions/usecases/retail-queue.jpg",
      metric: "-80% Slip Claims",
    },
  ],

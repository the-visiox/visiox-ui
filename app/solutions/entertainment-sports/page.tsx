...
import { Trophy, Gamepad2, Users, Sparkles, PlayCircle, Camera, Target } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  title: (
    <>
      The Edge of <br />
      <span className={["bg-gradient-to-r from-[#FF7300] to-[#F1A222] bg-clip-text", "text-transparent"].join(" ")}>
        Sensation.
      </span>
    </>
  ),
  subtitle: [
    "Where high-performance vision meets the thrill of the moment. We power the",
    "technical heart of modern entertainment and elite sports.",
  ].join(" "),
  ...
  capabilities: [
    {
      ...
      description:
        "High-precision tracking of player movement, velocity, and biomechanics for elite performance insights.",
  ...
  useCases: [
    {
      title: "Broadcast Player Tracking",
      tag: "Roboflow Sports",
      description: [
        "Real-time ball and player tracking to generate complex heatmaps and advanced",
        "analytics for live sports television broadcasts.",
      ].join(" "),
    ...
    },
    {
      ...
      tag: "Crowd Intel",
      description: [
        "Analyzing wide crowd shots to gauge aggregate joy, tension, and engagement",
        "during live events for production feedback.",
      ].join(" "),
      image: "/solutions/usecases/theme-park.jpg",
      metric: "100k+ Faces/Sec",
    },
    {
      title: "Markerless MoCap",
      tag: "Solomon 3D Base",
      description: [
        "Real-time, markerless motion capture tracking actors for immediate virtual",
        "production rendering and VFX pipelines.",
      ].join(" "),
      image: "/solutions/usecases/vfx-studio.jpg",
      metric: "-70% Setup Time",
    },
  ],

  ctaTitle: "Ready for the main stage?",
  ctaSubtitle:
    "Elevate your entertainment venue or broadcast capabilities with high-performance vision AI from VisioX.",

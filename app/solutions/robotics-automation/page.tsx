...
import { Bot, Box, Orbit, Maximize, Move, Zap, CheckCircle, Target } from "lucide-react";
...
const config: SolutionPageConfig = {
  ...
  subtitle: [
    "Equip your robotic systems with human-like visual perception. From bin picking",
    "to complex assembly, VisioX provides the precision needed to automate the",
    "unautomatable.",
  ].join(" "),
  ...
  useCases: [
    {
      title: "Welding Seam Tracking",
      tag: "SolMotion",
      description: "Real-time thermal and visual tracking of robotic welding paths to guarantee structural integrity.",
      image: "/solutions/usecases/smt-line.jpg",
      metric: "100% Path Accuracy",
    },
    {
      title: "Automated Palletizing",
      tag: "Logistics Robots",
      description: "Recognizing mixed-box dimensions and calculating optimal gripping points for warehouse robot arms.",
      image: "/solutions/usecases/palletizing.jpg",
      metric: "-50% Labor Dependency",
    },
    {
      title: "Robot Guidance SLAM",
      tag: "Roboflow Aerial",
      description: [
        "Vision-based simultaneous localization and mapping for AGVs navigating dynamic",
        "factory floors without QR codes.",
      ].join(" "),

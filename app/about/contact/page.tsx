      ...
      <section className="pt-32 pb-20 px-6 lg:px-8 max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <p className="text-xl text-stone-500 max-w-2xl leading-relaxed mb-16">
            Whether you need a custom enterprise solution, deep technical support, or a quick demo of our platform, our
            vision engineers are ready to chat.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className={[
                        "w-full px-4 py-3 rounded-xl border border-stone-200 bg-stone-50 focus:bg-white",
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={[
                      "w-full px-4 py-3 rounded-xl border border-stone-200 bg-stone-50 focus:bg-white",
                      "focus:ring-2 focus:ring-orange-500 outline-none transition-all resize-none",
                    ].join(" ")}
                  ></textarea>
                </div>
                <button
                  type="button"
                  className={[
                    "w-full py-4 text-white font-bold bg-orange-600 hover:bg-orange-700 rounded-xl",
            ...
            <div className="flex flex-col gap-8 justify-center lg:pl-12">
              <div className="flex items-start gap-4">
                <div
                  className={[
                    "w-12 h-12 bg-white rounded-xl shadow-sm border border-stone-200 flex items-center",

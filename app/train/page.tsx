        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. YOLOv8-PPE-run1"
              className={[
      ...
      <main className="flex-grow p-6 z-10">
            ...
            >
              <div
                className={[
                  ...
                  jobs.some((j) => j.status === "running") ? "bg-orange-500 animate-ping" : "bg-stone-300",
                ].join(" ")}
              />
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-8">
            <div
              className={[
                "bg-orange-50 rounded-3xl p-8 border border-orange-100 shadow-2xl shadow-orange-100/70",
                "relative overflow-hidden",
              ].join(" ")}
            >
              <div
                className={[
                  "absolute top-0 right-0 w-96 h-96 bg-orange-200/40 rounded-full blur-[120px] -mr-48",
                  "-mt-48",
                ].join(" ")}
              />
              <div
                className={[
                  "absolute bottom-0 left-0 w-64 h-64 bg-amber-200/30 rounded-full blur-[100px] -ml-32",
                  "-mb-32",
                ].join(" ")}
              />
              ...
              <div className="relative z-10">
                ...
                <div
                  className={[
                    "flex justify-between items-center text-stone-500 text-xs font-bold uppercase",
                    "tracking-widest border-t border-orange-100 pt-6",
                  ].join(" ")}
                >
              ...
              <div className="relative z-10">
                ...
                <button
                  className={[
                    ...
                    "text-sm flex items-center gap-2 shadow-xl shadow-orange-100/60 hover:bg-orange-200",
